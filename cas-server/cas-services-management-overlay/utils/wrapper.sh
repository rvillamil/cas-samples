...
#do
#  echo "cas-services-management-overlay - wrapper.sh - Waiting for database connection..."
#  sleep 5
#done

# Run application with container profile
java $JAVA_OPTS -Djava.security.egd=file:/dev/./urandom -Dspring.profiles.active=container -jar /cas-management.war
